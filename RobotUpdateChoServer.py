...
try:
    ...
    for hub in range(hubCount,2):
        ...
        for robot in range(1, 101):
            callback = r"""C:\Progra~1\Nimsoft\bin\pu -u administrator -p interOP@123 /CHOSERVER1_domain/CHOSERVER1_hub/CHOSERVER1/automated_deployment_engine deploy_probe robot_update 9.20HF7 /CHOSERVER1_domain/chosechub{}/my{}robot{}""".format(hubCount,hubCount,robotCount)
            print(callback)
